...
def connect_database():
    if emailEntry.get()=='' or usernameEntry.get()==''or passwordEntry.get()=='' or confirmEntry.get()=='' :
        ...
        try:
            ...
            mycursor.execute(query)
            query='create table users(userid int auto_increment primary key not null,email varchar(50),username varchar(100),password varchar(20))'
            mycursor.execute(query)
...
passwordEntry=Entry(signup_window,width=30,font=('Helvetica',10),fg='black',bg='#DCE5EF', show='*')
...
menuPhoto=PhotoImage(file=r'pics/menu.png')
