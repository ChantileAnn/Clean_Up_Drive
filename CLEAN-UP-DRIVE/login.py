...
def info_page():
    ...
    def view_records():
        ...
        def view_selected():
            ...
            sdg_label.grid(row=6, column=0, padx=10, pady=10, sticky=W)
            ...
            date_value.grid(row=5, column=1, padx=5, pady=10, sticky=W)
        ...
        def update_selected():
            ...
            def submit_update():
                ...
                cursor.execute(
    "UPDATE cleanupinfo SET first_name = %s, last_name = %s, state = %s, postal_code = %s, phone_number = %s, organization = %s, email = %s, clean_up_event = %s, years = %s, activity_location = %s, activity_type = %s, environmental_type = %s, date= %s WHERE id = %s",
                    (
                        fname.get(),
                        lname.get(),
                        state.get(),
            ...
            activity_location_value = ttk.Combobox(
                information_frame,
            ...
            activity_location_value.current(
                location_choices.index(records[0][10])
            )  # Set the default value
            activity_location_value.grid(row=4, column=1, padx=5, pady=10, sticky=W)
            ...
            updateSubmit.grid(row=6, column=4, padx=5, pady=10, sticky=W)
            ...
            date_value.current(
                date_choices.index(records[0][13])
            )  
            date_value.grid(row=5, column=0, padx=5, pady=10, sticky=W)
        ...
        def search_records(search_phrase):
            ...
            query = (
                ...
                "LOWER(clean_up_event) LIKE %s OR "
            )
        ...
        treeview.heading("#4", text="Province")
    ...
    def check_page():
        ...
        cursor.execute(
            """INSERT INTO cleanupinfo (first_name, last_name, state, postal_code, phone_number, organization, email, clean_up_event, years, activity_location, activity_type, environmental_type, date, sdg1, sdg2, sdg3, sdg4, sdg5, sdg6, sdg7, sdg8)
    ...
    cb4 = ttk.Combobox(cho_window, values=cho4, width=25)
    cb4.place(x=90, y=430)
    ...
    acttyLabel.place(x=300, y=405)
    cho = [
        "Rubbish Clean Up",
    ]
    cb1 = ttk.Combobox(cho_window, values=cho, width=25)
    cb1.place(x=300, y=430)
    ...
    enviLabel.place(x=500, y=405)
    cho1 = [
        "Waterway/River",
        "Wetland/Mangrove",
    ]
    cb2 = ttk.Combobox(cho_window, values=cho1, width=25)
    cb2.place(x=500, y=430)
    ...
    cb3 = ttk.Combobox(cho_window, values=cho2, width=20)
    cb3.place(x=700, y=430)
